...
var myMake = [
  "./zarandraca/assets/watt.mp3",
  "./zarandraca/assets/jadeo.mp3",
  "./zarandraca/assets/aullido.mp3",
];
...
function main() {
  ...
  function preload() {
    var assets = {
      spritesheet: {
        birdie: ["./zarandraca/assets/birdie.png", 24, 24],
        clouds: ["./zarandraca/assets/clouds.png", 128, 64],
      },
      image: {
        finger: ["./zarandraca/assets/finger.png"],
        fence: ["./zarandraca/assets/fence.png"],
      },
      audio: {
        flap: [randomSound],
        score: ["./zarandraca/assets/peron.mp3"],
        hurt: ["./zarandraca/assets/hurt.wav"],
      },
    };
