...
let img, img1;
import screenshot1 from "./../img/screenshots-1.jpg";
import screenshot2 from "./../img/screenshots-2.jpg";

sketck.preload = function () {
  // preload() runs once
  img = loadImage(screenshot1);
  img1 = loadImage(screenshot2);
};
